...
struct JobData
{	
	JobData(CTreeNode* in_pNode, nodestack* in_pNodes, TCondition* in_pNodesCond, int* in_pToDoN, 
			double in_alpha):
	pNode(in_pNode), pNodes(in_pNodes), pNodesCond(in_pNodesCond), pToDoN(in_pToDoN), alpha(in_alpha){}
